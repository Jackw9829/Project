                        ...
                        <?php foreach ($answers_result as $index => $answer): ?>
                            <div class="answer-item <?php echo $answer['is_correct'] ? 'correct' : 'incorrect'; ?>">
                                ...
                                <div class="options-list">
                                    <div class="option-item <?php echo ($answer['correct_answer'] === 'a') ? 'correct' : ''; ?> <?php echo ($answer['selected_answer'] === 'a') ? 'selected' : ''; ?>">
                                        <span class="option-prefix">A</span>
                                        <?php echo htmlspecialchars($answer['option_a']); ?>
                                        <?php if ($answer['selected_answer'] === 'a'): ?>
                                            <i class="material-icons user-selected">person</i>
                                        <?php endif; ?>
                                    ...
                                    <div class="option-item <?php echo ($answer['correct_answer'] === 'b') ? 'correct' : ''; ?> <?php echo ($answer['selected_answer'] === 'b') ? 'selected' : ''; ?>">
                                        <span class="option-prefix">B</span>
                                        <?php echo htmlspecialchars($answer['option_b']); ?>
                                        <?php if ($answer['selected_answer'] === 'b'): ?>
                                            <i class="material-icons user-selected">person</i>
                                        <?php endif; ?>
                                    ...
                                    <div class="option-item <?php echo ($answer['correct_answer'] === 'c') ? 'correct' : ''; ?> <?php echo ($answer['selected_answer'] === 'c') ? 'selected' : ''; ?>">
                                        <span class="option-prefix">C</span>
                                        <?php echo htmlspecialchars($answer['option_c']); ?>
                                        <?php if ($answer['selected_answer'] === 'c'): ?>
                                            <i class="material-icons user-selected">person</i>
                                        <?php endif; ?>
                                    ...
                                    <div class="option-item <?php echo ($answer['correct_answer'] === 'd') ? 'correct' : ''; ?> <?php echo ($answer['selected_answer'] === 'd') ? 'selected' : ''; ?>">
                                        <span class="option-prefix">D</span>
                                        <?php echo htmlspecialchars($answer['option_d']); ?>
                                        <?php if ($answer['selected_answer'] === 'd'): ?>
                                            <i class="material-icons user-selected">person</i>
                                        <?php endif; ?>
                                ...
                                <div class="answer-feedback <?php echo $answer['is_correct'] ? 'correct' : 'incorrect'; ?>">
                                    <?php if ($answer['is_correct']): ?>
                                        <i class="material-icons">check_circle</i> Correct! You earned <?php echo $answer['points_earned']; ?> points.
                                    <?php else: ?>
